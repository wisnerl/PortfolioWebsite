    ...
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <form
          ...
          <h2 className="text-stone-600 sm:text-4xl text-3xl mb-1 font-medium title-font">
            Contact Me
          </h2>
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              id="name"
              name="name"
              className="w-full bg-stone-300 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
          ...
          <div className="relative mb-4">
            ...
            <textarea
              id="message"
              name="message"
              className="w-full bg-stone-300 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 h-32 text-base outline-none text-gray-100 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
              onChange={(e) => setMessage(e.target.value)}
            />
          </div>
          <button
            type="submit"
            className="text-white bg-red-700 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">
            Submit
          </button>
        </form>
      </div>
