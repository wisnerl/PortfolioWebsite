  ...
  return (
    <section id="writing">
      <div className="container px-5 py-10 mx-auto text-center">
        ...
        <img
            className="object-center mx-auto rounded-2xl"
            alt="cover"
            src="./reapercover.jpg"
          />
        </div>
        ...
        <div class="w-full h-6 bg-gray-200 rounded-full xl:w-2/4 lg:w-3/4 mx-auto mb-6">
          <div class="h-6 bg-red-600 text-s font-medium text-red-300 text-center p-0.4 rounded-full" style={{width: `70%`}}>70%</div>
        </div>
        <div className="leading-relaxed bg-stone-300 rounded-lg xl:w-2/4 lg:w-3/4 mx-auto px-5 py-2">
